...
func _init():
	id = "OfficialTrenchcoatRed"

func getVisibleName():
	return "Official Trenchcoat (Red)"
...
func getRiggedParts(_character):
	if(itemState.isRemoved()):
		return null
	return {
		"clothing": "res://Modules/BDCCDD_ASSETS/Items/Clothes/OfficialTrenchcoatRed/OfficialTrenchcoatRed.tscn",
	}
