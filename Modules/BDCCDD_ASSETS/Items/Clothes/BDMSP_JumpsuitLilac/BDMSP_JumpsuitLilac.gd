...
func _init():
	id = "BDMSP_JumpsuitLilac"

func getVisibleName():
	return "BDMSP Lilac Prisoner Jumpsuit"
	
func getDescription():
	return "Prisoner jumpsuit for sexual deviants"
...
func getRiggedParts(_character):
	if(itemState.isRemoved()):
		return null
	return {
		"clothing": "res://Modules/BDCCDD_ASSETS/Items/Clothes/BDMSP_JumpsuitLilac/BDMSP_JumpsuitLilac.tscn",
	}
