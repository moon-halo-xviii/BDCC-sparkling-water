...
func getAnnouncerIntroduction():
	return "And in the right corner we have Kait. Some say her kick is the strongest in the prison! Combine that with the cat-like agility and you got yourself a truly furious warrior!"
