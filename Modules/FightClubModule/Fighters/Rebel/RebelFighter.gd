...
func getAvyIntroduction():
	return "Your next opponent is Rebel. She is a buff gal, dumb as a pile of bricks but can crush your skull with her left pinkie. So you know, avoid that and you will be fine."
