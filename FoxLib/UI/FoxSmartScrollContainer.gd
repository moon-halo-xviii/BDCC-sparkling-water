...
class_name FoxSmartScrollContainer
#public_api

# Take from BDCC 0.1.11 file under MIT License Copyright (c) 2021 Alex K
# See https://github.com/Alexofp/BDCC/blob/main/LICENSE for more info.
