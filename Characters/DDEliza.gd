...
func _getName():
	return "Eliza Pearson"

func getGender():
	return Gender.Female
	
func getSmallDescription() -> String:
	return "An elegant, yet tired looking feline with pastel yellow fur. Wears a lab coat and carries quite a few medical tools on her belt. Wears an ornate ring on her left hand."
...
func getFightIntro(_battleName):
	...
	text += "[say=eliza]"+RNG.pick([
		"I’m doctor Pearson. But you can call me Queen.",
...
func getDefaultEquipment():
	return ["LabcoatOutfitAlt", "LaceBra", "LacePanties", "ElizaNecklace"]
