...
func _getName():
	return "Alla Borisonova"

func _getGender():
	return Gender.Female

func getSmallDescription() -> String:
	return "A larger than normal sized chocolate lab with soft blue eyes. She wears a lilac uniform, and smells like tobacco."
...
func getDefaultEquipment():
	return ["BDMSP_JumpsuitLilac", "plainPanties", "plainBra", "inmatecollar",]
